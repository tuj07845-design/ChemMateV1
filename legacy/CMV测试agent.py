...
- `def bash(command: str, timeout: int = 60)`: 仅用于其它工具，比如path_finder找到文件，可以用，或用户描文件名比较模糊，其它情况禁用
# 输出格式要求:
...
DEFAULT_LLM_API_KEY = "sk-ws-H.EXEEMIH.UNxB.MEYCIQD3sDsC7dZW6cMUNUB6vzkWjj7HU9ch5PdPTeGIF4uhjAIhAPywYZUQ26J-xYSprjFLvDIiNFRpil0Y1tp0qWgltroN"
DEFAULT_LLM_BASE_URL = "https://dashscope.aliyuncs.com/compatible-mode/v1"
DEFAULT_LLM_MODEL_ID = "qwen3.8-max"
DEFAULT_TAVILY_API_KEY = "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"
